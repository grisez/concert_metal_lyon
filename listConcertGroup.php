...
<div class="container-fluid mt-5 mb-5">
  <div class="row justify-content-between mb-3">
    ...
    <div class="col-md-2 me-3">
      <a href="newConcertGroup.php" class="btn btn-outline-success colorButton my-2">Ajouter un concert</a>
    </div>
  </div>
  <div class='container'>
  ...
  <div class="row justify-content-center">
    <div class="col-lg-10">
      <h2 class="text-center mb-4 text-light">Concerts</h2>
        ...
        <table class="table table-bordered table-hover table-striped text-center">
          ...
          <tbody>
            <?php foreach ($listConcertGroups as $listConcertGroup) { ?>
              <tr>
                <td class="text-light"><?php echo $listConcertGroup['img_event']; ?></td>
                <td class="text-light"><?php echo $listConcertGroup['name_event']; ?></td>
                <td class="text-light"><?php echo $listConcertGroup['NewDate_event']; ?></td>
                <td class="text-light"><?php echo $listConcertGroup['price_event']; ?></td>
